...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_retention_policies_project_domain",
        "retention_policies",
        ["project_id", "domain_area"],
    )
    op.create_index(
        "idx_retention_policies_domain_policy",
        "retention_policies",
        ["domain_area", "policy_name"],
    )
    ...
    op.create_index(
        "idx_interaction_records_project_started",
        "interaction_records",
        ["project_id", sa.text("started_at DESC")],
    )
    op.create_index(
        "idx_interaction_records_project_interaction_started",
        "interaction_records",
        ["project_id", "interaction_id", sa.text("started_at DESC")],
    )
    op.create_index(
        "idx_interaction_records_type_started",
        "interaction_records",
        ["interaction_type", sa.text("started_at DESC")],
    )
    op.create_index(
        "idx_interaction_records_root_agent_started",
        "interaction_records",
        ["root_agent_id", sa.text("started_at DESC")],
        postgresql_where=sa.text("root_agent_id IS NOT NULL"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "interaction_id",
            sa.Text(),
            sa.ForeignKey("interaction_records.interaction_id"),
            nullable=True,
        ),
    ...
    op.create_index(
        ...
        "activity_records",
        ["project_id", "interaction_id", sa.text("occurred_at ASC")],
    )
    op.create_index(
    ...
    op.create_index(
        "idx_activity_records_project_domain_occurred",
        "activity_records",
        ["project_id", "domain_area", sa.text("occurred_at DESC")],
    )
    op.create_index(
        "idx_activity_records_project_target_occurred",
        "activity_records",
        ["project_id", "target_type", "target_id", sa.text("occurred_at DESC")],
    )
    op.create_index(
        "idx_activity_records_project_durability_occurred",
        "activity_records",
        ["project_id", "durability", sa.text("occurred_at DESC")],
    )
    op.create_index(
        "idx_activity_records_project_action_family_occurred",
        "activity_records",
        ["project_id", "action_family", sa.text("occurred_at DESC")],
    )
    op.create_index(
        "idx_activity_records_retention_expiry",
        "activity_records",
        ["retention_policy_id", "retention_expires_at"],
        postgresql_where=sa.text("retention_expires_at IS NOT NULL"),
    )
    op.create_index(
        "idx_activity_records_parent_occurred",
        "activity_records",
        ["parent_activity_id", sa.text("occurred_at ASC")],
        postgresql_where=sa.text("parent_activity_id IS NOT NULL"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "activity_id",
            sa.Text(),
            sa.ForeignKey("activity_records.activity_id"),
            nullable=False,
        ),
        sa.Column("project_id", sa.Text(), nullable=True),
        sa.Column("domain_area", sa.Text(), nullable=False),
    ...
    op.create_index(
        "idx_activity_snapshots_project_target_created",
        "activity_snapshots",
        ["project_id", "target_type", "target_id", sa.text("created_at DESC")],
    )
    op.create_index(
        "idx_activity_snapshots_activity", "activity_snapshots", ["activity_id"]
    )
    op.create_index(
        "idx_activity_snapshots_retention_expiry",
        "activity_snapshots",
        ["retention_policy_id", "retention_expires_at"],
        postgresql_where=sa.text("retention_expires_at IS NOT NULL"),
    )
    ...
    op.create_index(
        "idx_activity_diffs_project_target_created",
        "activity_diffs",
        ["project_id", "target_type", "target_id", sa.text("created_at DESC")],
    )
    ...
    op.create_index(
        "idx_activity_evidence_links_activity",
        "activity_evidence_links",
        ["activity_id"],
    )
    op.create_index(
        ...
        "activity_evidence_links",
        ["activity_id", "evidence_type", "evidence_id"],
        unique=True,
    )
    op.create_index(
        "idx_activity_evidence_links_project_evidence",
        "activity_evidence_links",
        ["project_id", "domain_area", "evidence_type", "evidence_id"],
    )
    op.create_index(
        "idx_activity_evidence_links_project_type_created",
        "activity_evidence_links",
        ["project_id", "evidence_type", sa.text("created_at DESC")],
    )
    ...
    op.create_index(
        "idx_retention_applications_policy_applied",
        "retention_applications",
        ["retention_policy_id", sa.text("applied_at DESC")],
    )
    op.create_index(
    ...
    op.create_index(
        "idx_retention_applications_project_target_applied",
        "retention_applications",
        ["project_id", "target_type", "target_id", sa.text("applied_at DESC")],
    )
    ...
    op.create_table(
        ...
        sa.Column("retention_policy_id", sa.Text(), nullable=True),
        sa.Column(
            "purged_evidence_classes", postgresql.ARRAY(sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "idx_purge_tombstones_project_target_created",
        "purge_tombstones",
        ["project_id", "target_type", "target_id", sa.text("created_at DESC")],
    )
    op.create_index(
        "idx_purge_tombstones_activity", "purge_tombstones", ["activity_id"]
    )
    op.create_index(
        "idx_purge_tombstones_retention_created",
        "purge_tombstones",
        ["retention_policy_id", sa.text("created_at DESC")],
    )
    ...
    op.create_index(
        "idx_system_record_write_failures_project_created",
        "system_record_write_failures",
        ["project_id", sa.text("created_at DESC")],
    )
    op.create_index(
        "idx_system_record_write_failures_domain_created",
        "system_record_write_failures",
        ["domain_area", sa.text("created_at DESC")],
    )
